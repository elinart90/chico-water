    ...
    <div className="min-h-screen">
      ...
      <div className="bg-gradient-to-br from-water-900 to-water-700 pt-28 pb-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-white/70 text-lg max-w-xl mx-auto">Questions about wholesale pricing? Want to set up a corporate account? We typically respond within 2 hours on business days.</p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid lg:grid-cols-3 gap-10">
          ...
          <div className="space-y-5">
            {[
              { icon: Phone, label: 'Phone', value: s.business_phone || '+233 20 000 0000', href: `tel:${s.business_phone || '+233200000000'}`, sub: 'Mon–Sat, 7AM–6PM' },
              ...
              { icon: Mail, label: 'Email', value: s.business_email || 'orders@chicowater.com', href: `mailto:${s.business_email || 'orders@chicowater.com'}`, sub: 'Response within 24h' },
              { icon: MapPin, label: 'Address', value: s.business_address || 'Industrial Area, Accra', href: '#', sub: '' },
            ].map(item => (
            ...
            <div className="card p-5 bg-gray-50">
              ...
              <div className="space-y-1 text-sm">
                <div className="flex justify-between"><span className="text-gray-500">Mon – Friday</span><span className="font-medium">7:00 AM – 6:00 PM</span></div>
                <div className="flex justify-between"><span className="text-gray-500">Saturday</span><span className="font-medium">8:00 AM – 4:00 PM</span></div>
                <div className="flex justify-between"><span className="text-gray-500">Sunday</span><span className="font-medium">8:00 AM – 2:00 PM</span></div>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-2 card p-8">
            {sent ? (
              <div className="text-center py-10">
                ...
                <p className="text-gray-500">We'll get back to you within 24 hours. For urgent matters, please call or WhatsApp us directly.</p>
              </div>
            ) : (
              <>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div className="grid sm:grid-cols-2 gap-5">
                    <div>
                      ...
                      <input value={form.name} onChange={e => setForm(f => ({ ...f, name: e.target.value }))} className="input" placeholder="Kwame Mensah" required />
                    </div>
                    <div>
                  ...
                  <div>
                    ...
                    <textarea value={form.message} onChange={e => setForm(f => ({ ...f, message: e.target.value }))} className="input resize-none" rows={5} placeholder="Tell us how we can help you..." required />
                  </div>
